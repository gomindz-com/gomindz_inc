const projects = [
  ...
  { id: "p5", title: "AI-Powered Diagnostic Support System for Breast Cancer", desc: "Developed an intelligent diagnostic support tool that leverages AI to assist radiologists and healthcare specialists in identifying potential signs of breast cancer. The system enhances early detection accuracy, reduces workload, and supports better patient outcomes.", category: "ai", img: "/images/projects/brest cancer.png", link: "https://mammo-vision-suite.vercel.app/", tags: ["Next Js", "Python", "TypeScript"] },
